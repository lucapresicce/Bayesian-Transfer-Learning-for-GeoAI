...
postdens_ws <- mcmc_areas(posterior_ws,
  ...
  scale_y_discrete(labels = c(expression(Sigma[list(1,1)]), expression(Sigma[list(2,1)]), expression(Sigma[list(2,2)]),
                              expression(Sigma[list(1,3)]), expression(Sigma[list(2,3)]), expression(Sigma[list(3,3)]),
                              expression(beta[list(1,1)]), expression(beta[list(2,1)]), expression(beta[list(1,2)]),
...
posterior_asmk <- cbind(sigma2_mat[,c(1,2,5,3,6,9)], beta_mat)
colnames(posterior_asmk)<- c("Sigma[1,1]", "Sigma[1,2]", "Sigma[2,2]", "Sigma[1,3]", "Sigma[2,3]", "Sigma[3,3]",
                           "beta[1,1]", "beta[2,1]", "beta[1,2]", "beta[2,2]", "beta[1,3]", "beta[2,3]")
...
postdens_asmk <- mcmc_areas(posterior_asmk,
                          prob = 0.95,
                          point_est = "mean") + 
  ggtitle("Posterior distributions - MASMK - Sequantial Learning",
          "with posterior means, and 95% credible intervals") +
  scale_y_discrete(labels = c(expression(Sigma[list(1,1)]), expression(Sigma[list(2,1)]), expression(Sigma[list(2,2)]),
                              expression(Sigma[list(1,3)]), expression(Sigma[list(2,3)]), expression(Sigma[list(3,3)]),
                              expression(beta[list(1,1)]), expression(beta[list(2,1)]), expression(beta[list(1,2)]),
...
postint_asmk <- mcmc_recover_intervals(posterior_asmk, true_par,
  ...
  scale_x_discrete(labels = c(expression(beta[list(1,1)]), expression(beta[list(2,1)]), expression(beta[list(1,2)]),
                              ...
                              expression(Sigma[list(1,1)]), expression(Sigma[list(2,1)]), expression(Sigma[list(1,3)]),
                              expression(Sigma[list(2,2)]), expression(Sigma[list(2,3)]), expression(Sigma[list(3,3)]))) + 
  ggtitle("Credible intervals - MASMK - Sequential Learning",
          "with posterior means, true values, and 89% - 95% credible intervals")
