## UNIVARIATE TRANSFER LEARNING SIMULATION ##########################################################################################################
...
png("output/surface_TLwell.png", width = width, height = height, pointsize = pointsize, family = "sans")
par(mfrow = c(1, 2))
...
height <- 360
pointsize <- 12
png("output/CIpost_TLwell.png", width = width, height = height, pointsize = pointsize, family = "sans")
...
png("output/surface_TLmis.png", width = width, height = height, pointsize = pointsize, family = "sans")
par(mfrow = c(1, 2))
iw <- as.image.SpatialGridDataFrame(surf.Y)
iy <- as.image.SpatialGridDataFrame(surf.Yhat)
plot(crd, type="n", cex=0.5, xlim=xlim, axes=FALSE, ylab="Northing", xlab="Easting",
...
png("output/CIpost_TLmis.png", width = width, height = height, pointsize = pointsize, family = "sans")
...
png("output/surface_TLhms.png", width = width, height = height, pointsize = pointsize, family = "sans")
par(mfrow = c(1, 2))
iw <- as.image.SpatialGridDataFrame(surf.Y)
iy <- as.image.SpatialGridDataFrame(surf.Yhat)
plot(crd, type="n", cex=0.5, xlim=xlim, axes=FALSE, ylab="Northing", xlab="Easting",
...
png("output/CIpost_TLhms.png", width = width, height = height, pointsize = pointsize, family = "sans")
...
png("output/surface_TLbps.png", width = width, height = height, pointsize = pointsize, family = "sans")
par(mfrow = c(1, 2))
iw <- as.image.SpatialGridDataFrame(surf.Y)
iy <- as.image.SpatialGridDataFrame(surf.Yhat)
plot(crd, type="n", cex=0.5, xlim=xlim, axes=FALSE, ylab="Northing", xlab="Easting",
...
png("output/CIpost_TLbps.png", width = width, height = height, pointsize = pointsize, family = "sans")
cowplot::plot_grid(postint_asmk)
dev.off()
