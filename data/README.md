...
"_Bayesian Transfer Learning for Artificially Intelligent Geospatial Systems: A Predictive Stacking Approach_" considers a large-scale set of georeferenced data, strictly related to critical problems in today's Climate Sciences. As a reminder, the analysis work on the Vegetation Index data, providing a full Bayesian inference over the entire global surface, including millions of units. Raw data is freely available for download from the following web portals: [EarthData MOD13C1 v061](https://lpdaac.usgs.gov/products/mod13c1v061/), for whose metadata is available.
...
Since the original format and size of the raw dataset, some preprocessing steps are mandatory before starting any analysis. Here, the R script (`.R` format) is thus presented:
...
* [`NDVI_data_2024_05_12.RData`](../data/NDVI_data_2024_05_12.RData): preprocessed data for multivariate analysis in Section 6 (reference date of data 05/12/2024);
<!--
